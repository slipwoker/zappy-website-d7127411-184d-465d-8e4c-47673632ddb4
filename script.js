document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.dataset.minlength && !VALIDATORS.minlength(value, field.dataset.minlength)) {
    ...
    function removeFormMessages() {
      const existing = document.querySelectorAll('.form-success-message, .form-error-message');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd7127411-184d-465d-8e4c-47673632ddb4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd7127411-184d-465d-8e4c-47673632ddb4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd7127411-184d-465d-8e4c-47673632ddb4';
